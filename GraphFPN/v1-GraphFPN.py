...
from utils.MeanunPooling import MeanunPooling
...
class Net(torch.nn.Module):
    def __init__(self, ):
        ...
        self.unpool1 = MeanunPooling()
        self.bn4 = torch.nn.BatchNorm1d(dim)

        self.conv5 = GINConv(Seq(Lin(64, 64), ReLU(), Lin(64, 64)))
        self.unpool2 = SAGPooling(64, min_score=0.01, GNN=GCNConv)
        self.bn5 = torch.nn.BatchNorm1d(dim)

        self.conv6 = GINConv(Seq(Lin(64, 64), ReLU(), Lin(64, 64)))

        self.attn = torch.nn.Linear(384, 3)

        self.lin1 = torch.nn.Linear(384, dataset.num_classes)
        # self.lin1 = torch.nn.Linear(384, 64)
    ...
    def forward(self, data):
        ...
        # P：第A层
        x4, edge_index = self.unpool1(x0, x3, edge_index0, edge_index1, perm1)
        x4 = x4 + x0
