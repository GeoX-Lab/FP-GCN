...
for epoch in tqdm(range(config.epoch)):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), '../run/{}_dataset{}_seed{}.pth'.format(modelname, config.dataname, args.seed))
