...
test_loader = DataLoader(test_dataset, batch_size=config.batch_size, num_workers=5, shuffle=True)
train_loader = DataLoader(train_dataset, batch_size=config.batch_size, num_workers=5, shuffle=False)
